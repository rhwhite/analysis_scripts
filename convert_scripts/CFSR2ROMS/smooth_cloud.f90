...
INTEGER LonDimID, LatDimID, TimeDimId,TimeVarId, CloudVarId
...
DO imonth= month_st,12
   ...
   DO itime= 1,ntime
      ...
      ! Read in DLW value
      ! Get DLW var id
      status_cfsr = nf90_inq_varid(ncid_cfsr, "T_CDC_L200",CloudVarId)
      if(status_cfsr /= nf90_NoErr) call handle_err(status_cfsr)
      ...
      status_cfsr = nf90_put_var(ncid_cfsr,CloudVarId,scr,(/1,1,itime/))
      if(status_cfsr /= nf90_NoErr) call handle_err(status_cfsr)   
   ENDDO
