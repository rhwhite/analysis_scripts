...
#endif
INTEGER Bry_timeVarId, Clim_timeVarId
...
!climfile = '/mnt/export5/IPCC/GISS_AOM/SRES_A1B/GISSAOM_SRESA1B_clim.nc'
!bryfile = '/mnt/export5/IPCC/GISS_AOM/SRES_A1B/GISSAOM_SRESA1B_bry.nc'
!climfile = '/work/budgell/Moz_24th/Climatology/Moz_24th_clim_ia.nc'
!bryfile = '/work/budgell/Moz_24th/Data/Moz_24th_bry_ia.nc'
!climfile = '/work/budgell/Storfjord/Climatology/STFJ2_clim_1989-2008.nc'
!bryfile = '/work/budgell/Storfjord/Data/STFJ2_bry_1989-2008.nc'
!climfile = '/work/budgell/KARBIAC/Climatology/KARBIAC_Clim_Glob20km_1986-1988.nc'
!bryfile = '/work/budgell/KARBIAC/Data/KARBIAC_bry_Glob20km_1986-1988.nc'
!climfile = '/disk1/pbudgell/Brazil/Climatology_SODA/SODA_Brazil_OM_5km_clim.nc'
!bryfile = '/disk1/pbudgell/Brazil/Data/SODA_Brazil_OM_5km_bry.nc'
!climfile = '/disk1/pbudgell/Med40/Data/SODA_Med_40_clim.nc'
!bryfile = '/disk1/pbudgell/Med40/Data/SODA_Med_40_bry.nc'
!climfile ='/net/wrfstore3/disk1/mbroadbr/SODA/SODA_FSC_COARSE2/SODA_FSC_clim_15y_coarse_V2.nc'
climfile = 'SODA_FSC_COARSE2/SODA_FSC_clim_15y_coarse_V2.nc'
!bryfile = '/net/wrfstore3/disk1/mbroadbr/SODA/SODA_FSC_COARSE2/SODA_FSC_bry_15y_coarse_V2.nc'
bryfile = 'SODA_FSC_COARSE2/SODA_FSC_bry_15y_coarse_V2.nc'
...
write(*,*) 'Lp = ',Lp,',  Mp = ',Mp,',  N = ',N,',  ntime = ',ntime
...
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,nf90_global,'title','ROMS 3.0 Arctic-Atlantic 10km')
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,nf90_global,'history','From SODA climatology')
if(status /= nf90_NoErr) call handle_err(status)
!
...
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,Zeta_westVarId,'time','bry_time')
if(status /= nf90_NoErr) call handle_err(status)
...
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,Zeta_eastVarId,'time','bry_time')
if(status /= nf90_NoErr) call handle_err(status)
...
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,Zeta_southVarId,'time','bry_time')
if(status /= nf90_NoErr) call handle_err(status)
...
if(status /= nf90_NoErr) call handle_err(status)
status = nf90_put_att(nc,Zeta_northVarId,'time','bry_time')
if(status /= nf90_NoErr) call handle_err(status)
