...
if(status_1 /= nf90_NoErr) call handle_err(status_1)
! Get RAIN var id
status_1 = nf90_inq_varid(ncid_7, "RAIN",RAVarId)
if(status_1 /= nf90_NoErr) call handle_err(status_1)
! Get SNOW var id
status_1 = nf90_inq_varid(ncid_7, "SNOW",SNVarId)
if(status_1 /= nf90_NoErr) call handle_err(status_1)
...
write(*,*) greg
! Read in CP values
status_CORE = nf90_get_var(ncid_7,RAVarId,work,start=(/1, 1,itime /))
if(status_CORE /= nf90_NoErr) call handle_err(status_CORE)
TP = work
status_CORE = nf90_get_var(ncid_7,SNVarId,work,start=(/1, 1,itime /))
if(status_CORE /= nf90_NoErr) call handle_err(status_CORE)
TP = TP + work
